LANGUAGE = {
	quickHelp = "Para usar esse comando, solte a tecla \"C\" com o mouse no comando.",
	quickGiveMoney = "Dar dinheiro",
	quickDropMoney = "Dropar dinheiro",
	quickUseTie = "Amarrar pessoa",
	quickUseSpray = "Pichar",
	quickSearchPlayer = "Revista pessoa",
	quickSetPassword = "Senha escolhida",
	quickRefund = "Reembolso",
	quickBuyDoor = "Comprar porta",
	quickSellDoor = "Vender porta",
	quickCreateLawboard = "Criar telão com leis",
	quickSetPrice = "Escolher preço",
	quickGiveLicense = "Dar licensa",
	quickRevokeLicense = "Retirar licensa",
	quickCenter = "Comandos",

	setPassword = "Escolha a senha",
	setPasswordDesc = "Digite abaixo uma senha de 4 número",
	setAmount = "Escolha a quantia",
	setAmountDesc = "Digite abaixo a quantia",
	...
	apply = "Confirmar",
	cancel = "Cancelar",
	bankMoney = "Reserva Bancária",
	profitRate = "Profit Rate",
	profitAmount = "Quantia de lucro",
	reserveSalary = "Você recebeu %s do seu salário.",
	reserveIncome = "Sua conta tem %s de juros.",
	salaryRejected = "Seu salário foi rejeitado pelo governo.",
	deposit = "Depositar",
	withdraw = "Sacar",
	transfer = "Transferir",
	depositMoney = "Você depositou %s na sua conta.",
	withdrawMoney = "Você sacou %s de sua conta.",
	hospitalPrice = "%s reais foram tirados de sua conta para seu tratamento médico.",
	provideValidNumber = "Número inválido",
	cantAfford = "Você não tem dinheiro suficiente para comprar isso.",
	enterAmount = "Coloque a quantia de dinheiro desejada.",
	requireAttrib = "É necessário %s de habilidade para usar esse item. (%s/%s)",
	lotteryFail = "Você raspou seu bilhete da loteria e ganhou nada.",
	lotteryProfit = "Você raspou seu bilhete da loteria e ganhou %s.",
	stm = "Fôlego", --Stamina?
	health = "Vida",
	armor = "Colete",
	hunger = "Fome",
	help = "Ajuda",
	groupCreated = "Você criou a organização \"%s\".",
	groupDeleted = "Você dissolveu %s",
	groupPermission = "Você não permissão para usar esse comando.",
	groupFail = "Criação de grupo falhou.",
	groupExists = "Esse grupo já existe.",
	groupInvalid = "A organização não existe.",
	groupHUDLeader = "Lider do grupo: \"%s\".",
	groupHUD = "Membro do grupo: \"%s\".",
	groupGotKicked = "Você foi expulso da organização.",
	groupNotMember = "O alvo não pertence ao grupo.",
	groupKicked = "Você expulsou %s do seu grupo.",
	groupShort = "O nome da organização é muito pequeno.",
	groupChar = "Você é %s da organização: %s.",
	toggleEffects = "Usar efeitos de primeira pessoa.",
	radioFreq = "Frequência",
	radioSubmit = "Enviar",
	radioNoRadio = "Você não tem um rádio.",
	radioNoRadioComm = "Você não tem um rádio.",
	radioFormat = "[Rádio] %s: \"%s\"",
	vehicleDesc = "You've changed your car's information: %s.",
	vehicleExists = "Você já tem um carro.",
	vehicleStored = "Seu carro está guardado em uma garagem virtual.",
	notSky = "Você deve sair para spawnar o carro.",
	vehicleSpawned = "Você spawnou seu carro.",
	vehicleCloser = "Você precisa de chegar mais perto do carro.",
	vehicleStoredDestroyed = "Seu carro não existe, mas foi arquivado com sucesso.",
	vehicleGasFilled = "Você encher o tanque do carro com %d%%.",
	vehicleGasLook = "You've to look at the vehicle to fill the fuel.",
	stash = "Deposito",
	stashIn = "Manter",
	stashOut = "Ejetar",
	stashError = "Não foi possivel guardar itens no deposito.",
	stashMenu = "Armazém",
	stashDesc = "Você pode guardar seus itens com segurança aqui.",
	notAllowed = "As condições para essa ação não foram alcançadas.",
	purchaseEntity = "Você comprou %s em %s.",
	becomeClassVote = "Votação para emprego começou.",
	alreadyClassVote = "Votação para emprego em progresso.",
	notOwned = "Você não é dono disso.",
	cantAfford = "Você não tem dinheiro para comprar isso.",
	priceChanged = "Preço foi alterado para %s.",
	purchasedFoodProfit = "Sua maquina de venda fez %s de lucro.",
	purchasedFoodNonProfit = "Sua maquina de vende teve %s de lucro. :c", --I think is bad
	purchasedFood = "Você comprou comida.",
	cleanupChar = "Personagem trocado. Todas informações do antigo foram apagadas.",
	printerGone = "A impressora explodiu.",
	printerBork = "A impressora falhou.",
	printerSpeedUpgrade = "A velocidade da impressora foi aumentada.",
	printerCoolerUpgrade = "O resfriamento da impressora foi melhorado.",
	maxReached = "Esse tipo de maquina está fora de estoque.",
	maxReachedLaw = "Esse tipo de maquina pode ser comprada a %s em proporção com o número de policiais.",
	weaponSlotFilled = "Você já tem esse tipo de item.",
	/*
		ENTITY TRANSLATION
		NAME-DESCRIPTION TRANSLATION
	*/
	synthesizer = "Sintetizador",
	synthesizerGuitar = "Sintetizador guitar",
	synthesizerPiano = "Sintetizador piano",
	synthesizerViolin = "Sintetizador violin",
	jukebox = "Jukebox",
	...
	*/
	...
	weedPotName = "Pote de 7L",
	weedPotDesc = "Esse é um pode para cultivo de maconha.",
	weedPotSoil = "Se você usar isso, você comprará terra por %s",
	weedPotSeed = "Se você usar isso, você comprará sementes por %s",
	notInstalled = "Desinstalado",
	installed = "Instalado",
	level = "Nível",
	printerOwner = "%s's %s",
	printerDone = "Completo",
	printerFinal = "Quantia copiada",
	printerMul = "Drenagem policial",
	printerSpeed = "Velocidade",
	printerLevel = "Nível",
	atmWelcome = "Como posso te ajudar?",
	stashEntity = "Deposito",
	helloBoard = "Forum",
	helloBoardSub = "Visite!",
	serverBoard = "Board do servidor",
	serverBoardSub = "Status do servidor",
	playerJoinedServer = "%s conectou no servidor.",
	playerLeftServer = "%s saiu do servidor.",
	currentMoney = "Salário atual",
	moneyLeft = "Aposentadoria",
	stashFar = "Longe demais do deposito.",
	stashTip = "Você pode guardar seus itens preciosos aqui no cofre.",
	injured = "Parece machucado",
	injured1 = "Machucado",
	injured2 = "Ferido",
	injured3 = "Gravemente Ferido",
	stunned = "Desmaiado",
	afk = "Dormindo",
	hasLicense = "Segurando licensa",
	arrested = "Preso",
	onHit = "Em progresso",
	onWanted = "Procurado",
	onWarrant = "Mandato",
	...
	hitTarget = "Alvo",
	tied = "Amarrado",
	toggleObserverTP = "Use no lugar de NOCLIP",
	toggleTips = "Dicas",
	weaponChecker = "Detector de metais",
	...
	popcornVendorName = "Maquina de pipoca",
	popcornVendorDesc = "Uma maquina que faz pipoca.",
	snackVendorName = "Maquina de Lanches",
	snackVendorDesc = "Uma maquina que vende lanches e refrigerantes.",
	personalCovfefeName = "Maquina de Café",
	personalCovfefeDesc = "Uma maquina que faz café.",
	drinkVendorName = "Maquina de Refri",
	drinkVendorDesc = "Uma maquina com diversos refrigerantes.",
	microwave = "Microondas",
	citizen = "Civil",
	youArrest = "Você prendeu",
	seconds = "segundos",
	arrestedBy = "Você foi preso por",
	releasing = "Soltando",
	prisonReleased = "Você foi solto da cadeia",
	command = "CMD",
	medVen = "Você pode comprar suprimentos médicos aqui",
